...
import styles2 from '../styles/Menber4.module.css'//各自のcssに切り替え
  ...
  return (
          <>
            ...
            <div className={styles2.img_position}>
              <Image src='/tatsuta.jpg'//各自のアイコン画像
              width={250}
              height={250}
            ...
            &nbsp;
              ...
              <a charset="UTF-8" href="https://twitter.com/rd_tatsuta/">
            ...
            <ul　className={styles2.timeline}>
                ...
                <div className={styles2.date_small}>2020年4月</div>
                ...
                <h2 className={styles2.text_rule}>コンピュータソフトウェアコース　進学</h2>
                </div>
                </li>
                
                <li>
                <div className={styles2.content_li}>
                <div className={styles2.date_small}>2022年7月</div>
                <h2 className={styles2.text_rule}>学内専用SNSを共同製作者2人と制作</h2>
                </div>
                </li>
            </ul>
            </div>
